...
public abstract class AbstractEnumPLayout_BACK<E extends Enum<E>> extends AbstractPLayout implements PLayout {
	
	private final Class<E> enumClass;
	private final List<PComponent> compList;
	private final LinkedArray<PCompInfo> infoArray;
	
	protected AbstractEnumPLayout_BACK(PComponent component, Class<E> enumClass) {
		super(component);
